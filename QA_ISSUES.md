...
**Fix:** A single shared `maskPhoneDigits` (exported from `src/lib/sms-member-registry.js`) masks anything phone-shaped (8+ digits) down to `***` plus the last 4 before logging.
